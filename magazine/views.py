...
def index(request):
	...
	for key in data['sections']:
		...
		if data['sections'][key]:
			# print data['sections'][key]
			# print len(data['sections'][key])
			print random.sample(data['sections'][key],2)

			# 0 and len(data['sections'][key]) and then use those numbers to get articles
